  ...
  return (
    <>
      <TableLayout
        ...
        title="EMBED WIDGETS"
        stats={<TableStats items={stats} tooltip={`${widgets.length} Widget Configurations`} />}
        actions={
          <>
            <IconButton
              action="add"
          ...
          <div className="inline-create-form">
            <div className="inline-form-grid">
              <div className="form-field">
                <label className="form-label" htmlFor="widget-type">
                  Widget Type
                </label>
                <select
                  id="widget-type"
                  ...
                  onChange={(e) =>
                    setCreateForm((prev) => ({ ...prev, widgetType: e.target.value }))
                  }
                >
              ...
              <div className="form-field">
                <label className="form-label" htmlFor="widget-name">
                  Name
                </label>
                <input
                  id="widget-name"
              ...
              <div className="form-field">
                <label className="form-label" htmlFor="widget-domains">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCreateForm((prev) => ({ ...prev, allowedDomains: e.target.value }))
                  }
                />
              </div>
            </div>
        ...
        <PortalTable>
          ...
          <PortalTableBody animate={!isLoading && !error}>
            {error ? (
              ...
              <PortalTableEmpty colSpan={7} icon={<Inbox />} message="No embed widgets yet" />
            ) : (
              widgets.map((w) => (
                <PortalTableRow key={w.id}>
                  ...
                  <PortalTableCell className="status-col">
                    <StatusBadge
                      status={
                        w.isActive ? ('active' as StatusVariant) : ('inactive' as StatusVariant)
                      }
                    >
                  ...
                  <PortalTableCell className="date-col">{formatDate(w.createdAt)}</PortalTableCell>
