...
function useFormState<T extends Record<string, unknown>>(initial: T) {
  ...
  const validate = useCallback(
    (requiredFields: Array<{ field: keyof T; label: string }>): boolean => {
      ...
      {clientOptions && clientOptions.length > 0 && (
        <div className="form-field">
          ...
          <FormDropdown
            ...
            onChange={handleDropdown('clientId')}
...
export function CreateTaskModal({
  ...
  const handleFormSubmit = useCallback(
    async (e: React.FormEvent) => {
      e.preventDefault();
      if (!validate([{ field: 'title', label: 'Title' }])) {
        return;
      }
      await onSubmit(form);
      reset();
    ...
    >
      ...
      {projectOptions && projectOptions.length > 0 && (
        <div className="form-field">
          ...
          <FormDropdown
            ...
            onChange={handleDropdown('projectId')}
      ...
      <div className="form-field">
        ...
        <FormDropdown
          ...
          onChange={handleDropdown('priority')}
    ...
    >
      ...
      <div className="form-field">
        ...
        <textarea
          ...
          value={form.body_html as string}
          onChange={handleText('body_html')}
          required
        />
      </div>
    </PortalModal>
...
export function CreateKBCategoryModal({
  open,
  onOpenChange,
  onSubmit,
  loading = false
...
export function CreateKBArticleModal({
  open,
  onOpenChange,
  onSubmit,
  loading = false,
  categoryOptions
}: CreateKBArticleModalProps) {
  const { form, setForm, handleText, handleDropdown, handleCheckbox, reset } =
    useFormState(INITIAL_ARTICLE);
    ...
    >
      ...
      <div className="form-field">
        ...
        <FormDropdown
          ...
          onChange={handleDropdown('category_id')}
          placeholder="Select category"
        />
      </div>
      <div className="form-field">
        <PortalInput
          ...
          onChange={handleText('summary')}
        />
      </div>
      <div className="form-field">
        <label className="field-label" htmlFor="article-content">
          Content *
        </label>
        <textarea
          id="article-content"
      ...
      <div className="form-field">
        <label className="inline-checkbox">
          <input
            ...
            onChange={handleCheckbox('is_featured')}
          />{' '}
          Featured
        </label>
      </div>
      <div className="form-field">
        <label className="inline-checkbox">
          <input
            ...
            onChange={handleCheckbox('is_published')}
          />{' '}
          Published
        </label>
      </div>
...
export function CreateContractModal({
  ...
  const { form, errors, handleText, handleDropdown, validate, reset } =
    useFormState(INITIAL_CONTRACT);
  ...
  return (
    ...
    >
      ...
      <div className="form-field">
        <label className="field-label" htmlFor="contract-content">
          Contract Content *
        </label>
        <textarea
          id="contract-content"
...
export function CreateDocumentRequestModal({
  ...
  const {
    ...
    validate,
    reset
  } = useFormState(INITIAL_DOC_REQUEST);
    ...
    >
      ...
      <div className="form-field">
        ...
        <FormDropdown
          ...
          onChange={handleDropdown('client_id')}
          placeholder="Select client"
        />
      </div>
      <div className="form-field">
        ...
        <FormDropdown
          ...
          onChange={handleDropdown('project_id')}
          placeholder="Select project"
        />
      </div>
      <div className="form-field">
        ...
        <FormDropdown
          ...
          value={form.document_type as string}
          onChange={handleDropdown('document_type')}
      ...
      <div className="form-field">
        <PortalInput
          ...
          onChange={handleText('due_date')}
        />
      </div>
      <div className="form-field">
        <label className="field-label" htmlFor="doc-request-desc">
          Description
        </label>
        <textarea
          id="doc-request-desc"
...
export function CreateAdHocRequestModal({
  open,
  onOpenChange,
  onSubmit,
  loading = false,
  clientOptions,
  projectOptions
}: CreateAdHocRequestModalProps) {
  const { form, errors, handleText, handleDropdown, validate, reset } =
    useFormState(INITIAL_AD_HOC);
    ...
    >
      ...
      <div className="form-field">
        ...
        <FormDropdown
          ...
          value={form.requestType as string}
          onChange={handleDropdown('requestType')}
          placeholder="Select type"
        />
      ...
      <div className="form-field">
        <PortalInput
          ...
          placeholder="0"
          value={form.estimatedHours as string}
          onChange={handleText('estimatedHours')}
        />
      </div>
      <div className="form-field">
        <label className="field-label" htmlFor="adhoc-desc">
          Description *
        </label>
        <textarea
          id="adhoc-desc"
    ...
    >
      ...
      <div className="form-field">
        <PortalInput
          ...
          value={form.reviewDeadline as string}
          onChange={handleText('reviewDeadline')}
        />
      </div>
      <div className="form-field">
        <label className="field-label" htmlFor="deliverable-desc">
          Description
        </label>
        <textarea
          id="deliverable-desc"
...
export function CreateTimeEntryModal({
  ...
  const { form, errors, handleText, handleDropdown, handleCheckbox, validate, reset } =
    useFormState(INITIAL_TIME_ENTRY);
  ...
  return (
    ...
    >
      ...
      <div className="form-field">
        <label className="field-label" htmlFor="time-desc">
          Description
        </label>
        <textarea
          id="time-desc"
      ...
      <div className="form-field">
        <label className="inline-checkbox">
          <input
            type="checkbox"
            checked={form.billable as boolean}
            onChange={handleCheckbox('billable')}
          />{' '}
          Billable
        </label>
      </div>
    ...
    >
      ...
      <div className="form-field">
        ...
        <FormDropdown
          ...
          value={form.projectType as string}
          onChange={handleDropdown('projectType')}
          placeholder="Select type"
        />
      ...
      <div className="form-field">
        ...
        <FormDropdown
          ...
          value={form.selectedTier as string}
          onChange={handleDropdown('selectedTier')}
      ...
      <div className="form-field">
        <PortalInput
          ...
          label="Final Price *"
          placeholder="0.00"
          value={form.finalPrice as string}
          onChange={handleText('finalPrice')}
          required
        />
      </div>
    </PortalModal>
