 ...
 */
export const StatCard = React.memo(({ label, value, variant = 'default', onClick, isActive, icon, meta, className }: StatCardProps) => {
  const classes = cn(
    'stat-card',
 ...
 * </StatsRow>
 */
export const StatsRow = React.memo(({ children, className }: StatsRowProps) => {
