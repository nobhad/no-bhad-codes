...
- [x] About page ink treatment (photo border wobble, heading filter, divider brush stroke, corner ink pools) — `src/styles/pages/about-ink.css` + `#ink-wobble` / `#ink-wobble-bold` / `#ink-wobble-heavy` filter defs in `index.html`
