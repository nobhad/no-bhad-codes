...
- [ ] **Analytics Business tab: Conversion Funnel + Lead Sources broken** — The Conversion Funnel shows all bars at 10% width with 0 counts and 100% percentages (placeholder data). Lead Sources shows "undefined leads", "undefined won", and empty source names. Data binding is broken and the visual design needs improvement. Both components need proper empty states and better styling.
