-- UP
-- Migration: Fix missing proposal enhancement tables
-- Created: 2026-03-14
-- Issue: Migration 032 always fails because it ALTER TABLEs proposal_requests
-- which doesn't exist until migration 047. This migration creates the missing
-- tables and adds the missing columns safely.
...
-- =====================================================
-- MARK MIGRATION 032 AS EXECUTED
-- =====================================================
-- Migration 032 can never succeed because it tries to ALTER TABLE proposal_requests
-- which doesn't exist until migration 047. Since this migration creates all the
-- tables that 032 would have created, mark 032 as done to prevent repeated failures.
INSERT OR IGNORE INTO migrations (id, name, filename) VALUES (32, 'proposal enhancements', '032_proposal_enhancements.sql');
...
DELETE FROM migrations WHERE id = 32;
