...
export const toPaymentTermsPreset = createMapper<TypedPaymentTermsPresetRow, PaymentTermsPreset>(paymentTermsPresetSchema);
export const toInvoicePayment = createMapper<TypedInvoicePaymentRow, InvoicePayment>(invoicePaymentSchema);
export const toPaymentPlanTemplate = createMapper<TypedPaymentPlanTemplateRow, PaymentPlanTemplate>(paymentPlanTemplateSchema);
export const toScheduledInvoice = createMapper<TypedScheduledInvoiceRow, ScheduledInvoice>(scheduledInvoiceSchema);
export const toRecurringInvoice = createMapper<TypedRecurringInvoiceRow, RecurringInvoice>(recurringInvoiceSchema);
export const toInvoiceReminder = createMapper<TypedInvoiceReminderRow, InvoiceReminder>(invoiceReminderSchema);
export const toInvoiceCredit = createMapper<TypedInvoiceCreditRow, InvoiceCredit>(invoiceCreditSchema);
...
export function toInvoice(row: TypedInvoiceRow): Omit<Invoice, 'lineItems'> {
  type BaseInvoice = Omit<Invoice, 'lineItems' | 'businessName' | 'businessContact' | 'businessEmail' | 'businessWebsite' | 'venmoHandle' | 'paypalEmail'>;
