...
import { generateProjectPlan } from '../services/project-generator.js';
...
router.post('/', async (req, res) => {
  try {
    ...
    try {
      ...
      const projectPlan = await generateProjectPlan(intakeData, projectId);
      
      // Generate initial invoice
      const invoice = await generateInvoice(intakeData, projectId, clientId);
...
function generateProjectName(projectType, companyName) {
  const typeNames = {
