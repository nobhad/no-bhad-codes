...
export { proposalService, SignatureAuthorizationError } from '../../services/proposal-service.js';
export type { SignatureAuthorizationReason } from '../../services/proposal-service.js';
