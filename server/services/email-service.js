 ...
 */
export async function sendWelcomeEmail(email, name, accessToken) {
 ...
 */
export async function sendNewIntakeNotification(intakeData, projectId) {
...
function generateWelcomeEmailHTML(name, portalUrl) {
  return `
    <!DOCTYPE html>
    <html>
    <head>
...
function generateIntakeNotificationHTML(intakeData, projectId) {
